const HomepageSysreq = () => {
  return (
    <section className=" max-w-screen-2xl mx-auto flex col justify-center h-screen bg-sysreq bg-center bg-cover lg:p-32 md:p-10 px-5 py-10 space-y-20 text-white shadow-sm">
      ...
      <div className="md:w-3/4 bg-black opacity-80 flex col tracking-wider border border-gray-700">
        <div className="flex w-full">
          <div className="border-b border-r border-gray-700 w-1/2 p-4">
            <h3 className="text-lg lg:text-2xl text-primary mb-1">OS :</h3>
            <p>Windows 7 64-bit only (No OSX support at this time)</p>
          </div>
          <div className="border-b border-gray-700 w-1/2 p-4">
            <h3 className="text-lg lg:text-2xl text-primary mb-1">
              PROCESSOR:
            </h3>
        ...
        <div className="flex w-full">
          <div className="w-1/2 border-b border-r border-gray-700 p-4">
            <h3 className="text-lg lg:text-2xl text-primary mb-1">MEMORY :</h3>
            <p>4GB RAM</p>
          </div>
          <div className="w-1/2 border-b border-gray-700 p-4">
            <h3 className="text-lg lg:text-2xl text-primary mb-1">STORAGE :</h3>
            <p>8 GB available space</p>
          </div>
        </div>
        <div className="flex p-4 col">
          <h3 className="text-lg lg:text-2xl text-primary mb-1">GRAPHICS :</h3>
